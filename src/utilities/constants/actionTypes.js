const actionTypes = {
  ...
  LEADERBOARD_FILTER_REQUESTED: 'LEADERBOARD_FILTER_REQUESTED',
  LEADERBOARD_FILTER_SUCCEEDED: 'LEADERBOARD_FILTER_SUCCEEDED',
  LEADERBOARD_FILTER_FAIL: 'LEADERBOARD_FILTER_FAIL',
  
  TOURNAMENT_LISTING_REQUESTED: 'TOURNAMENT_LISTING_REQUESTED',
  TOURNAMENT_LISTING_SUCCEEDED: 'TOURNAMENT_LISTING_SUCCEEDED',
  TOURNAMENT_LISTING_FAIL: 'TOURNAMENT_LISTING_FAIL',

  TERMS_AND_CONDITION_REQUESTED: 'TERMS_AND_CONDITION_REQUESTED',
  TERMS_AND_CONDITION_SUCCEEDED: 'TERMS_AND_CONDITION_SUCCEEDED',
  TERMS_AND_CONDITION_FAIL: 'TERMS_AND_CONDITION_FAIL',
  
  MEMBER_LISTING_REQUESTED: 'MEMBER_LISTING_REQUESTED',
  MEMBER_LISTING_SUCCEEDED: 'MEMBER_LISTING_SUCCEEDED',
  MEMBER_LISTING_FAIL: 'MEMBER_LISTING_FAIL',
  
  MEMBER_LOADMORE_REQUESTED: 'MEMBER_LOADMORE_REQUESTED',
  MEMBER_LOADMORE_SUCCEEDED: 'MEMBER_LOADMORE_SUCCEEDED',
  MEMBER_LOADMORE_FAIL: 'MEMBER_LOADMORE_FAIL',
    
  SEND_FRIEND_REQUESTS_REQUESTED: 'SEND_FRIEND_REQUESTS_REQUESTED',
  SEND_FRIEND_REQUESTS_SUCCEEDED: 'SEND_FRIEND_REQUESTS_SUCCEEDED',
  SEND_FRIEND_REQUESTS_FAIL: 'SEND_FRIEND_REQUESTS_FAIL',
  
  UNBLOCK_USER_REQUESTED: 'UNBLOCK_USER_REQUESTED',
  UNBLOCK_USER_SUCCEEDED: 'UNBLOCK_USER_SUCCEEDED',
  UNBLOCK_USER_FAIL: 'UNBLOCK_USER_FAIL',

  IMPORTANT_LINKS_REQUESTED: 'IMPORTANT_LINKS_REQUESTED',
  IMPORTANT_LINKS_SUCCEEDED: 'IMPORTANT_LINKS_SUCCEEDED',
  IMPORTANT_LINKS_FAIL: 'IMPORTANT_LINKS_FAIL',
  
  SURVEY_QUESTION_REQUESTED: 'SURVEY_QUESTION_REQUESTED',
  SURVEY_QUESTION_SUCCEEDED: 'SURVEY_QUESTION_SUCCEEDED',
  SURVEY_QUESTION_FAIL: 'SURVEY_QUESTION_FAIL',

  SAVE_SURVEY_QUESTION_REQUESTED: 'SAVE_SURVEY_QUESTION_REQUESTED',
  SAVE_SURVEY_QUESTION_SUCCEEDED: 'SAVE_SURVEY_QUESTION_SUCCEEDED',
  SAVE_SURVEY_QUESTION_FAIL: 'SAVE_SURVEY_QUESTION_FAIL',


  GET_BLOGS_REQUESTED: 'GET_BLOGS_REQUESTED',
  GET_BLOGS_SUCCEEDED: 'GET_BLOGS_SUCCEEDED',
  GET_BLOGS_FAIL: 'GET_BLOGS_FAIL',

  GET_BLOG_CATEGORY_REQUESTED: 'GET_BLOG_CATEGORY_REQUESTED',
  GET_BLOG_CATEGORY_SUCCEEDED: 'GET_BLOG_CATEGORY_SUCCEEDED',
  GET_BLOG_CATEGORY_FAIL: 'GET_BLOG_CATEGORY_FAIL',

  CREATE_BLOGS_REQUESTED: 'CREATE_BLOGS_REQUESTED',
  CREATE_BLOGS_SUCCEEDED: 'CREATE_BLOGS_SUCCEEDED',
