...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.GET_BLOGS_REQUESTED:
      return {
        ...state,
        loading: true,
      };

    case actionTypes.GET_BLOGS_SUCCEEDED:
      return {
        ...state,
        loading: false,
      };
    ...
    case actionTypes.CREATE_BLOGS_REQUESTED:
      return {
        ...state,
        loading: true,
      };

    case actionTypes.CREATE_BLOGS_SUCCEEDED:
      return {
        ...state,
        loading: false,
      };

    case actionTypes.CREATE_BLOGS_FAIL:
      return {
        ...state,
        loading: false,
      };

      case actionTypes.GET_BLOG_CATEGORY_REQUESTED:
        return {
          ...state,
          loading: true,
        };
  
      case actionTypes.GET_BLOG_CATEGORY_SUCCEEDED:
        return {
          ...state,
          loading: false,
        };
  
      case actionTypes.GET_BLOG_CATEGORY_FAIL:
        return {
          ...state,
          loading: false,
        };
