...
//     params
// })
const loginWithEmail = (params, cb) => {
    return {
        type: actionTypes.LOGIN_WITH_EMAIL_REQUESTED,
        params,
        cb,
...
const verifyLoginAction = (params) => ({
    type: actionTypes.VERIFY_EMAIL_REQUESTED,
    params
})
...
export { fetchData, loginWithEmail, checkIfLoggedIn, logout, socialLoginSignup, signUpWithEmail, loginWithPhone, verifyPhoneOtp, forgotPassword, verifyForgotPasswordOtp, updatePassword, completeRegiter, change_Password, verifyLoginAction };
